...
For the **same gas at different temperatures**, the curve broadens and shifts to higher velocity as temperature increases, because the average Kinetic Energy is directly proportional to the absolute temperature. 

If gas 1 has higher temperature,


$$
\text{average KE} = \tfrac{1}{2} m {v}^2 \propto T
$$


$$
\text{average KE}_1  =\tfrac{1}{2} m_1 {v_1}^2 > \text{average KE}_2 =\tfrac{1}{2} m_2 {v_2}^2
$$
...
If gas 1 has higher molar mass, 


$$
\text{average KE} = \tfrac{1}{2} m_1 {v_1}^2 = \tfrac{1}{2} m_2 {v_2}^2
$$
